...
function configurationPage(
  ...
  return [
    ...
    '.pill-preview{width:92px;height:76px;display:flex;align-items:center;justify-content:center;background:#e8e8e8;border-radius:8px}',
